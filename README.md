...
The code base was tested with gym (0.17.2), pybullet (2.8.5) with a python version of 3.6.9. However it is expected to work fine for any future versions of these packages, though they havent been tested.
